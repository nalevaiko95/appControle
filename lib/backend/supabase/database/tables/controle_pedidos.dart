...
class ControlePedidosTable extends SupabaseTable<ControlePedidosRow> {
  @override
  String get tableName => 'controle_pedidos';

  @override
  ControlePedidosRow createRow(Map<String, dynamic> data) =>
      ControlePedidosRow(data);
}

class ControlePedidosRow extends SupabaseDataRow {
  ControlePedidosRow(super.data);

  @override
  SupabaseTable get table => ControlePedidosTable();
  ...
  String? get tipoPedido => getField<String>('tipo_pedido');
  set tipoPedido(String? value) => setField<String>('tipo_pedido', value);
}
