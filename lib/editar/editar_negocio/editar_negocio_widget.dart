...
import 'editar_negocio_model.dart';
export 'editar_negocio_model.dart';

class EditarNegocioWidget extends StatefulWidget {
  const EditarNegocioWidget({
    super.key,
  ...
  @override
  State<EditarNegocioWidget> createState() => _EditarNegocioWidgetState();
}

class _EditarNegocioWidgetState extends State<EditarNegocioWidget> {
  late EditarNegocioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarNegocioModel());
    ...
    return FutureBuilder<List<ControleCadastroNegocioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ControleCadastroNegocioRow>
            editarNegocioControleCadastroNegocioRowList = snapshot.data!;

        final editarNegocioControleCadastroNegocioRow =
            editarNegocioControleCadastroNegocioRowList.isNotEmpty
                ? editarNegocioControleCadastroNegocioRowList.first
                : null;
                                                    ...
                                                    if ((_model
                                                      ...
                                                      ClipRRect(
                                                        ...
                                                        child: Image.network(
                                                          valueOrDefault<
                                                              String>(
                                                            editarNegocioControleCadastroNegocioRow
                                                                ?.logo,
                                              ...
                                              await ControleCadastroNegocioTable()
                                                ...
                                                data: {
                                                  ...
                                                  'cnpj': _model
                                                      .txtCNPJTextController
                                                      .text,
                                                  'inscricao_estadual': _model
                                                      .txtIETextController.text,
                                                  'rua': _model
                                                      .txtRuaTextController
                                                      .text,
