...
class _PerfilWidgetState extends State<PerfilWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ControleClientesRow>>(
      future: ControleClientesTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<ControleClientesRow> perfilControleClientesRowList =
            snapshot.data!;

        final perfilControleClientesRow =
            perfilControleClientesRowList.isNotEmpty
                ? perfilControleClientesRowList.first
                : null;
                                ...
                                Expanded(
                                  child: AutoSizeText(
                                    valueOrDefault<String>(
                                      perfilControleClientesRow?.nome,
                                      '-',
                                    ),
