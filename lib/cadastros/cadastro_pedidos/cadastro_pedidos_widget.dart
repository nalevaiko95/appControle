...
import 'cadastro_pedidos_model.dart';
export 'cadastro_pedidos_model.dart';

class CadastroPedidosWidget extends StatefulWidget {
  const CadastroPedidosWidget({super.key});

  @override
  State<CadastroPedidosWidget> createState() => _CadastroPedidosWidgetState();
}

class _CadastroPedidosWidgetState extends State<CadastroPedidosWidget>
    with TickerProviderStateMixin {
  late CadastroPedidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroPedidosModel());
