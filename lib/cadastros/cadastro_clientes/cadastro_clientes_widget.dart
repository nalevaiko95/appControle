...
import 'cadastro_clientes_model.dart';
export 'cadastro_clientes_model.dart';

class CadastroClientesWidget extends StatefulWidget {
  const CadastroClientesWidget({super.key});

  @override
  State<CadastroClientesWidget> createState() => _CadastroClientesWidgetState();
}

class _CadastroClientesWidgetState extends State<CadastroClientesWidget> {
  late CadastroClientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroClientesModel());
    ...
    _model.txtNumeroInscricaoTextController ??= TextEditingController();
    ...
    _model.txtEstadoTextController1 ??= TextEditingController();
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await ControleClientesTable().insert({
                                  ...
                                  'id_negocio': FFAppState().negocioSelecionado,
                                  ...
                                  'numero': _model.txtNumeroTextController.text,
                                  'complemento':
